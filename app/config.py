...
class Config(object):
    ...
    API_SPEC_OPTIONS = {"info": {"description": "This is the API Specification of the forest-service ("
                                                "https://github.com/UST-QuAntiL/forest-service).", },
