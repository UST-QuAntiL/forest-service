...
class TranspileResponse:
    def __init__(self, depth, multi_qubit_gate_depth, number_of_measurement_operations, number_of_multi_qubit_gates,
                 number_of_single_qubit_gates, total_number_of_operations, transpiled_quil, width):
        super().__init__()
        self.depth = depth
        ...
        self.transpiled_quil = transpiled_quil
        self.width = width
    ...
    def to_json(self):
        json_transpile_response = {"depth": self.depth, "multi_qubit_gate_depth": self.multi_qubit_gate_depth,
                                   ...
                                   "transpiled_quil": self.transpiled_quil, "width": self.width, }
...
class TranspileResponseSchema(ma.Schema):
    ...
    transpiled_quil = ma.fields.String()
    width = ma.fields.Int()
